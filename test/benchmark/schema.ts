...
import { sequelize, models } from './models.ts';

const node = sequelizeNodeInterface(sequelize);
const nodeInterface = node.nodeInterface;

// These are initialized after their lazy GraphQL field thunks are declared.
// eslint-disable-next-line prefer-const
let userType: GraphQLObjectType;
// eslint-disable-next-line prefer-const
let subtaskConnection: ReturnType<typeof connectionDefinitions>;
